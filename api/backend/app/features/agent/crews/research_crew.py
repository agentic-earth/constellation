...
class ResearchCrew:
    ...
    def research_task(query: str, agent: Agent) -> Task:
        return Task(
            ...
            description=f"Find the most similar paper to user's query: '{query}', and provide a summary of the paper, and also you should find the link to the GitHub repository of the paper.",
