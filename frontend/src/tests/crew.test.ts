...
const API_URL = 'sk-WCt96z3T6pan0cwlSVtv_X7hXqEdVP04VfbVNzGiJpT3BlbkFJ8vYD3dakbsZYU3w9hYOfZS_n35PEdDJDuYCQ92Q4gA';
...
describe('AI Crews Integration Tests', () => {
  ...
  describe('Research Crew Tests', () => {
    test('should search for papers with given query', async () => {
      ...
      const response = await axios.post(`${API_URL}/research/search`, {
        query,
      }, {
        headers: {
  ...
  describe('Dev Crew Tests', () => {
    ...
    test('should handle invalid GitHub URLs', async () => {
      ...
      await expect(axios.post(`${API_URL}/dev/analyze`, {
  ...
  describe('Crew Process Tests', () => {
    test('should create and execute a research crew', async () => {
      const response = await axios.post(`${API_URL}/crews/research`, {
