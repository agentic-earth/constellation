...
from app.alchemy_models import Block
...
class BlockService:
    ...
    async def create_block(self, block_data: BlockCreateSchema, session: AsyncSession) -> Optional[BlockResponseSchema]:
        ...
        try:
            ...
            # Create a new Block ORM instance
            new_block = Block(
            ...
            # Insert the new block into Postgres
    ...
    async def get_blocks_by_ids(self, block_ids: List[UUID], session: AsyncSession) -> Optional[List[BlockResponseSchema]]:
        """
    ...
    async def associate_version(self, block_id: UUID, version_id: UUID, session: AsyncSession) -> bool:
        """
    ...
    async def list_all_blocks(self, session: AsyncSession) -> Optional[List[BlockResponseSchema]]:
        """
