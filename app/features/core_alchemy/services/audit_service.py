...
from app.alchemy_models import AuditLog
...
class AuditService:
    ...
    async def create_audit_log(self, audit_data: AuditLogCreateSchema, session: AsyncSession) -> Optional[AuditLogResponseSchema]:
        """
        ...
        try:
            ...
            audit_response = AuditLogResponseSchema(
                **audit_log
            )
    ...
    async def get_audit_log_by_id(self, log_id: UUID, session: AsyncSession) -> Optional[AuditLogResponseSchema]:
        """
    ...
    async def list_audit_logs(self, session: AsyncSession, filters: Optional[Dict[str, Any]] = None) -> Optional[List[AuditLogResponseSchema]]:
        """
    ...
    async def delete_audit_log(self, log_id: UUID, session: AsyncSession) -> bool:
        """
